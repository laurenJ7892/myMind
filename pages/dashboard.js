  ...
  return (
    <>
      ...
      <main className="flex grid grid-cols grid-cols-1 md:grid-rows w-full h-full">
        <div className="flex grid grid-rows md:grid-cols md: grid-cols-1 mt-5 flex h-[30vh] md:h-[50vh] w-[90%] mx-auto text-2xl font-bold bg-blue-100">
          <h2 className="flex items-center mx-auto mt-5 w-[90%]">Hey there {user.user_metadata.first_name}</h2>
          <p className="flex w-[90%] text-base mx-auto h-[20vh] md:h-[15vh] bg-blue-100">
